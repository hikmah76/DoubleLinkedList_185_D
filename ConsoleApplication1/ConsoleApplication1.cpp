...
int main() {
	...
	while (true) {
		try {
			...
			cout << "3. View all records in the ascending orderof roll number" << endl;
			cout << "4. View all records in the descending orderof roll number" << endl; 
